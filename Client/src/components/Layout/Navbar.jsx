...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-transparent border-gray-200 dark:bg-transparent max-w-screen flex flex-wrap items-center justify-between my-2 px-1 py-1">
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
        <div className="logo-container">
      <Link
        to="/Workspace"
        className=" items-center ml-2 space-x-3 rtl:space-x-reverse  hidden sm:block"
      >
        <img
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse justify-end order-last mr-5">
          <button
            className="relative mr-2 h-7 max-h-[40px] w-7 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all dark:text-white dark:font-semibold   hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          ...
          >
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-6 h-6 text-lg leading-none"
            >
              <path
